...
INSERT INTO Dept VALUE(101, '경영지원부', '051-512-1001');
INSERT INTO Dept VALUE(102, '영업부', '051-512-1002');
INSERT INTO Dept VALUE(103, '개발부', '051-512-1003');
INSERT INTO Dept VALUE(104, '인사부', '051-512-1004');
INSERT INTO Dept VALUE(105, '기획부', '051-512-1005');
SELECT * FROM Dept;
...
INSERT INTO Sale (empno, year, month, price) VALUES (1007, '2020', 1, 11100);
# 25 ----------------------------------------------------------------------
INSERT INTO Sale (empno, year, month, price) VALUES (1002, '2020', 2, 12000);
...
SELECT * FROM Employee WHERE job IS NOT NULL; -- job이 NULL인 직원
